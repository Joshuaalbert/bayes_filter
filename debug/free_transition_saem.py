...
if __name__ == '__main__':
    ...
    with sess.graph.as_default():
        ...
        filtered_res, inits = free_transition.filter_step(
            ...
            num_burnin_steps=100,num_saem_samples=100,saem_learning_rate=1.,initial_stepsize=7e-3,
            init_kern_params={'variance':0.5e-4,'y_sigma':0.2,'lengthscales':15.,'timescale':50.})
        sess.run(inits)
        cont = True
        while cont:
